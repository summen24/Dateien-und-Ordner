...
// SCHÜLERVERSION: Keine Spoiler, keine Antwort-Aufdeckung
(function(){
  document.querySelectorAll('.slide').forEach(s => { s.style.display='none'; s.classList.remove('is-active'); });
  ...
  // Aufgabe 1: Klicken DEAKTIVIERT – Schüler schreiben selbst
  // (kein Event Listener hinzugefügt)

  // Spoiler: KEIN click Handler – Lücken bleiben leer
  // (kein Event Listener hinzugefügt)
})();
